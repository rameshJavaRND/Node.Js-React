...
export default class AddInventory extends Component{
    ...
    add = (event) => {
        ...
        const newProduct = {
            ...
            vendor: this.formData.current.vendor.value,
            warranty: Number(this.formData.current.warranty.value)
        }
            ...
            <div>
                <Form onSubmit={this.add} ref={this.formData}>
                    ...
                    <Form.Group controlId="formBasicVendor">
                        ...
                        <Form.Control type="text" placeholder="Enter Vendor" name="vendor" />
                    </Form.Group>

                    <Form.Group controlId="formBasicWarranty">
                        <Form.Label>Warranty:</Form.Label>
                        <Form.Control type="number" placeholder="How many: years" name="warranty" />
                    </Form.Group>
